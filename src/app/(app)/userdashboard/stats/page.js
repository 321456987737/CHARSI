...
const StatsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white py-6 px-4 pt-[110px]">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-3 sm:gap-4">
          <StatCard title="Views" value={totals.views} />
          <StatCard title="Saved" value={totals.saved} />
          <StatCard title="Likes" value={totals.likes} />
        </div>
